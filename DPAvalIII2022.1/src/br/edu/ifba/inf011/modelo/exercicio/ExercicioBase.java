...
public class ExercicioBase implements Exercicio{
	...
	private String video = "[NO FLY - VIDEO DO EXERCICIO ";
	
	
	protected ExercicioBase(String id, String descricao, List<TipoExercicio> tipos,
	...
	public void reproduzir(PrintStream out, int qtde, int numRepeticoes) {
		out.println(video + " " + descricao + "] / " + qtde + " x " + numRepeticoes);
	}
}
