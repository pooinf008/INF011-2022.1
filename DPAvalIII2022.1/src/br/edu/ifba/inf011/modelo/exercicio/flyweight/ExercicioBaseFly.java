...
public class ExercicioBaseFly implements Exercicio{

	private String id;
	private List<TipoExercicio> tipos;
	private List<GrupoMuscular> gruposMusculares;
	private List<Equipamento> equipamentos;
	private ExercicioVideo video;
	
	
	
	protected ExercicioBaseFly(String id, ExercicioVideo video, List<TipoExercicio> tipos,
	...
	public String toString() {
		String desc = this.id + "\t" + this.video.getDescricao();
		desc += "\n\t";		
	...
	public String getDescricao() {
		return this.video.getDescricao();
	}
	...
	public void reproduzir(PrintStream out, int qtde, int numRepeticoes) {
		video.reproduzir(out, qtde, numRepeticoes);
	}
